...
const Navbar = () => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 rounded-b-3xl ${
          isScrolled
            ? "bg-[#2a2a2a]/95 backdrop-blur-md shadow-lg"
            : "bg-[#2a2a2a]/90 backdrop-blur-sm shadow-md"
        }`}
      >
        <nav className="container mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 lg:h-28">
            ...
            <div className="flex items-center gap-4 lg:gap-6">
              ...
              >
                <motion.span
                  className={`w-6 h-0.5 rounded-full transition-all duration-300 bg-white group-hover:bg-amber-600`}
                  animate={isOpen ? { rotate: 45, y: 3 } : { rotate: 0, y: 0 }}
                  transition={{ duration: 0.3 }}
                />
                <motion.span
                  className={`w-6 h-0.5 rounded-full mt-1.5 transition-all duration-300 bg-white group-hover:bg-amber-600`}
              ...
              <button
                ...
                className="hidden sm:block text-sm lg:text-base tracking-normal transition-colors text-white hover:text-amber-200"
              >
                Menu
              </button>
            </div>
            ...
            <div className="flex items-center">
              <Link
                to="/contact"
                className="px-6 lg:px-8 py-2.5 lg:py-3 rounded-full text-sm lg:text-base font-medium transition-all duration-300 bg-white text-gray-900 hover:bg-amber-100 hover:shadow-lg"
              >
                Book
              </Link>
            </div>
